...
public final class Constantes {
    ...
    public static final String ERRO_CADASTRAR_CICLISTA = "Erro ao cadastrar o ciclista";
    public static final String EMAIL_CONFIRMADO_SUCESSO = "E-mail confirmado com sucesso.";
    public static final String ERRO_ATIVAR_CICLISATA = "Erro ao ativar o ciclista.";
    public static final String CICLISTA_ALTERADO_SUCESSO = "Ciclista alterado com sucesso.";
    public static final String ERRO_ALTERAR_CICLISTA = "Erro ao alterar o ciclista.";
